...
public class BrokerTestCase {
  ...
  /**
   * Whether to run the test or not. Subclasses can check whether some broker features are available
   * or not, and choose not to run the test.
   *
   * @return
   */
  ...
  /**
   * Should create any AMQP resources needed by the test. Will be called by BrokerTestCase's
   * implementation of setUp, after the connection and channel have been opened.
   */
  protected void createResources() throws IOException, TimeoutException {}

  /**
   * Should destroy any AMQP resources that were created by the test. Will be called by
   * BrokerTestCase's implementation of tearDown, after the connection and channel have been closed
   * and reopened specifically for this method. After this method completes, the connection and
   * channel will be closed again.
   */
  ...
  protected void bareRestart() throws IOException {
  ...
  protected void basicPublishPersistent(byte[] msg, String x, String routingKey)
      throws IOException {
  ...
  public void basicPublishVolatile(
      byte[] msg, String x, String routingKey, AMQP.BasicProperties properties) throws IOException {
