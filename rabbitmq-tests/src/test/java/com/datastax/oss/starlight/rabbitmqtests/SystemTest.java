 ...
 *
 * <p>System tests are able to run both with local installed Pulsar cluster (e.g. testcontainers)
 * and with an external Pulsar cluster.
 *
 * <p>Note: it is expected the external Pulsar cluster to have default configuration with the <code>
