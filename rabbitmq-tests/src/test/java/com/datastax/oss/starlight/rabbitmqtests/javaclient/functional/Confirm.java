...
public class Confirm extends BrokerTestCase {
  ...
  @Test
  public void nonDurable() throws IOException, InterruptedException, TimeoutException {
    confirmTest("", "confirm-test-nondurable", true, false);
  }

  @Test
  public void mandatoryNoRoute() throws IOException, InterruptedException, TimeoutException {
    confirmTest("", "confirm-test-doesnotexist", false, true);
    confirmTest("", "confirm-test-doesnotexist", true, true);
  }

  @Test
  public void multipleQueues() throws IOException, InterruptedException, TimeoutException {
  ...
  @Test
  public void queueDelete() throws IOException, InterruptedException, TimeoutException {
  ...
  @Test
  public void queuePurge() throws IOException, InterruptedException, TimeoutException {
    publishN("", "confirm-test-noconsumer", true, false);
  ...
  @Test
  public void confirmQueuePurge() throws IOException, InterruptedException, TimeoutException {
    channel.basicQos(1);
  ...
  @Test
  public void basicReject() throws IOException, InterruptedException, TimeoutException {
  ...
  @Test
  public void queueTTL() throws IOException, InterruptedException, TimeoutException {
  ...
  @Test
  @Ignore("Needs transactions to be implemented.")
  ...
  @Test
  public void waitForConfirmsWithoutConfirmSelected() throws IOException, InterruptedException {
  ...
  private void publishN(
      String exchangeName, String queueName, boolean persistent, boolean mandatory)
      throws IOException {
    for (long i = 0; i < NUM_MESSAGES; i++) {
  ...
  protected void publish(
    ...
    channel.basicPublish(
        ...
        mandatory,
        false,
        persistent ? MessageProperties.PERSISTENT_BASIC : MessageProperties.BASIC,
        "nop".getBytes());
  }
}
