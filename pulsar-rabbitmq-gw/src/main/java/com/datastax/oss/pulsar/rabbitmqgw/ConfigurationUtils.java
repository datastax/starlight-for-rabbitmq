...
public final class ConfigurationUtils {
  ...
  /**
   * Creates PulsarConfiguration and loads it with populated attribute values loaded from provided
   * property file.
   *
   * @param configFile
   * @throws IOException
  ...
  /**
   * Creates PulsarConfiguration and loads it with populated attribute values from provided
   * Properties object.
   *
   ...
   */
  public static <T> void update(Map<String, String> properties, T obj)
      throws IllegalArgumentException {
    Field[] fields = obj.getClass().getDeclaredFields();
    // super fields
    Field[] superFields = obj.getClass().getSuperclass().getDeclaredFields();

    Stream.of(fields, superFields)
        .flatMap(Stream::of)
        .forEach(
            f -> {
